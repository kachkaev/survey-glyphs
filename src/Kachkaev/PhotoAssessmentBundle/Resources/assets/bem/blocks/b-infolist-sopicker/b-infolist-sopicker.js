...
var LANG_SORT_MODES = {
        ...
        'suitability-q0-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[0]] + ')',
        'suitability-q1-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[1]] + ')',
        'suitability-q2-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[2]] + ')',
        'suitability-q3-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[3]] + ')',
        'suitability-q4-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[4]] + ')',
        'suitability-q5-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[5]] + ')',
        'suitability-q6-avg': 'avg suitability (' + pat.config.lang.hintQuestions[pat.config.questions[6]] + ')',
        
        'suitability-med': 'med suitability',
        'suitability-q0-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[0]] + ')',
        'suitability-q1-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[1]] + ')',
        'suitability-q2-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[2]] + ')',
        'suitability-q3-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[3]] + ')',
        'suitability-q4-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[4]] + ')',
        'suitability-q5-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[5]] + ')',
        'suitability-q6-med': 'med suitability (' + pat.config.lang.hintQuestions[pat.config.questions[6]] + ')',
